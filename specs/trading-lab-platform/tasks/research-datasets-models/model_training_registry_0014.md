...
Define baseline and candidate model artifacts, metrics, manifests, seeds, and evaluation expectations.

## Why

Model output influences strategy decisions and must be reproducible and evaluated honestly.

## What

A model lifecycle capability for training configs, purged validation, registry manifests, calibration metrics, and rollback evidence.

## User / System Story

As a platform operator or implementation agent,
I want model training, evaluation, and registry,
so that the trading-lab platform can satisfy the related requirements with evidence.

## Source Traceability

- requirements.md: Req 16, 26, 27, 46
- design.md: AI/ML Design; Training Pipeline; Evaluation and Calibration; Model Registry
...
AI/ML Design; Training Pipeline; Evaluation and Calibration; Model Registry. This feature states the expected capability and review evidence without prescribing code-level implementation details beyond the design and project rules.
...
- walk-forward validation evidence; manifest schema tests; registry smoke tests
...
- feature registry; dataset snapshots; configs

## Risks / Edge Cases

- Tuning on holdout data invalidates reported edge.
