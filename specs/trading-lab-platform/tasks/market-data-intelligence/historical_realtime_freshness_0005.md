...
Define ingestion outcomes for historical bars, realtime updates, freshness tracking, and degraded-mode behavior.

## Why

Strategies and dashboards need to know when data is current enough to trust.

## What

A freshness capability for backfill, realtime updates, rate limits, missing-data handling, and degraded/alerted operation.

## User / System Story

As a platform operator or implementation agent,
I want historical and realtime ingestion freshness,
so that the trading-lab platform can satisfy the related requirements with evidence.

## Source Traceability

- requirements.md: Req 19, 30, 37, 41
- design.md: Historical Ingestion; Real-Time Data Flow; Missing Data Handling; Circuit Breakers
...
Historical Ingestion; Real-Time Data Flow; Missing Data Handling; Circuit Breakers. This feature states the expected capability and review evidence without prescribing code-level implementation details beyond the design and project rules.
...
- freshness metric tests; missing data fixtures; reconnect smoke tests
...
- source catalog; monitoring metrics; run degraded mode

## Risks / Edge Cases

- Realtime promises can exceed free-source limits.
