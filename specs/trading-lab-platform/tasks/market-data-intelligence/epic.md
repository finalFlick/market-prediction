# Epic: Market Data and Intelligence Ingestion
...
Give runs trustworthy market, portfolio, and external intelligence inputs with freshness and provenance controls.
...
- requirements.md: Req 3, 5, 9, 18, 19, 30
- design.md: Components 1, 2, 5, Market Data Design, Data Quality and Validation
...
- [ ] [FEATURE-0004 - Market Source Catalog and Symbol Policy](./market_source_catalog_0004.md)
- [ ] [FEATURE-0005 - Historical and Realtime Ingestion Freshness](./historical_realtime_freshness_0005.md)
- [ ] [FEATURE-0006 - Manual Insight Intake and Source Confirmation](./manual_insight_confirmation_0006.md)
- [ ] [FEATURE-0007 - Schwab CSV Portfolio Context](./schwab_csv_portfolio_context_0007.md)
