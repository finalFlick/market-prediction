# Epic: Risk and Execution Safety
...
Protect capital by keeping all target positions behind risk checks, broker registry, paper simulation, reconciliation, and live gates.
...
- requirements.md: Req 4, 5, 20, 23, 24, 25, 31, 32, 36
- design.md: Components 7, 8, 9, Risk Management Design, Execution System Design, Security Considerations
...
- [ ] [FEATURE-0021 - Non-Bypassable Risk Path](./non_bypassable_risk_path_0021.md)
- [ ] [FEATURE-0022 - Paper Broker and Broker Registry](./paper_broker_registry_0022.md)
- [ ] [FEATURE-0023 - Fill Reconciliation and Account State](./fill_reconciliation_account_state_0023.md)
- [ ] [FEATURE-0024 - Live Enablement Gate and Manual Override Ceremony](./live_enablement_gate_0024.md)
