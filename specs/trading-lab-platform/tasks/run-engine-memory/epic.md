...
Make each experiment a reproducible, isolated run with durable artifacts, event history, and bounded autonomy.
...
- requirements.md: Req 6, 7, 8, 10, 11, 12, 17
- design.md: Components 3, 4, 14, RunConfig, RunEvent, API command pattern
...
- [ ] [FEATURE-0008 - Run Lifecycle and Isolation](./run_lifecycle_isolation_0008.md)
- [ ] [FEATURE-0009 - Run Memory and Artifact Replay](./run_memory_artifact_replay_0009.md)
- [ ] [FEATURE-0010 - MVP-0 and v1 Run Type Catalog](./run_type_catalog_0010.md)
- [ ] [FEATURE-0011 - Approval Queue and Autonomy Boundaries](./approval_autonomy_boundaries_0011.md)
