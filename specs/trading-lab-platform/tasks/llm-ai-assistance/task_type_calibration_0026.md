...
Define how LLM task types are calibrated and evaluated as research-support signals without entering the trading path.

## Why

Different LLM tasks have different reliability; calibration lets routing improve based on evidence.

## What

A calibration capability for task_type labels, outcome metrics, evaluation datasets, and operator feedback.

## User / System Story

As a platform operator or implementation agent,
I want task-type calibration as a research signal,
so that the trading-lab platform can satisfy the related requirements with evidence.

## Source Traceability

- requirements.md: Req 16, 22, 44, 45
- design.md: LLM calibration by task_type; AI/ML Evaluation and Calibration; Learning component
...
LLM calibration by task_type; AI/ML Evaluation and Calibration; Learning component. This feature states the expected capability and review evidence without prescribing code-level implementation details beyond the design and project rules.
...
- calibration dataset checks; feedback metric tests; no execution import tests
...
- LLM trace logging; learning scores; run feedback UI

## Risks / Edge Cases

- Calibration metrics can be circular if based on LLM-generated labels.
