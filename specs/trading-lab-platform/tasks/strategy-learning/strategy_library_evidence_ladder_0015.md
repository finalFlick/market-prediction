...
Define strategy contracts, archetype categories, versioning, and R-ladder promotion/demotion expectations.

## Why

The platform needs disciplined evidence before expanding strategy exposure.

## What

A strategy capability covering target-position outputs, version history, evidence states, and promotion gates.

## User / System Story

As a platform operator or implementation agent,
I want strategy library and evidence ladder,
so that the trading-lab platform can satisfy the related requirements with evidence.

## Source Traceability

- requirements.md: Req 13, 14, 20, 27
- design.md: Component 6; Strategy Engine Design; Live Trading Promotion Flow
...
Component 6; Strategy Engine Design; Live Trading Promotion Flow. This feature states the expected capability and review evidence without prescribing code-level implementation details beyond the design and project rules.
...
- strategy interface tests; R-state transition tests; gate evidence review
...
- backtest metrics; risk engine; strategy configs

## Risks / Edge Cases

- Strategy code can accidentally emit orders or quantities.
