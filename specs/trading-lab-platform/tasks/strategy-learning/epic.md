# Epic: Strategy Framework and Learning Loop
...
Let the platform test, rank, promote, demote, and learn from strategies without exceeding evidence or risk boundaries.
...
- requirements.md: Req 13, 14, 15, 17, 24, 27, 44, 45
- design.md: Components 6, 14, 15, Strategy Engine Design, Learning Loop
...
- [ ] [FEATURE-0015 - Strategy Library and Evidence Ladder](./strategy_library_evidence_ladder_0015.md)
- [ ] [FEATURE-0016 - Adaptive Universe and Bandit Allocation](./adaptive_universe_bandit_0016.md)
- [ ] [FEATURE-0017 - OOS-Only Learning Lever Scoring](./oos_learning_lever_scoring_0017.md)
